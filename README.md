...
The Gallery section and the Products section both pull from `assets/gallery/` — screenshots of Gaming Premier League, Gaming Royale, Drama Shots, and GHSUPERWINNINGS. Clicking any gallery image opens it larger in a lightbox (`script.js` handles this, no dependencies).
